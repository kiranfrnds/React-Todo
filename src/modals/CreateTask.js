        ...
        <Modal isOpen={modal} toggle={toggle}>
            ...
            <ModalBody>
                    ...
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="projectstatus" id="progress" value="progress" onChange = {handleChange} />
                        <label class="form-check-label" htmlFor="progress" >In Progress</label>
                    </div>
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="projectstatus" id="completed" value="completed" onChange = {handleChange}/>
                        <label className="form-check-label" htmlFor="completed">Completed</label>
                    </div>
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="projectstatus" id="uncompleted" value="uncompleted" onChange = {handleChange} />
            ...
            <Button color="secondary" onClick={() => toggleFun()}>Cancel</Button>
            </ModalFooter>
      </Modal>
    );
};
