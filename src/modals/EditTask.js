...
const EditTaskPopup = ({modal, toggle, updateTask, taskObj}) => {
    ...
    },[taskObj.Description, taskObj.Email, taskObj.Name,
        taskObj.Projectname, taskObj.Status, taskObj.enddate,
        taskObj.mobilenumber, taskObj.startdate])
        ...
        <Modal isOpen={modal} toggle={toggle}>
            ...
            <ModalBody>
                    ...
                    <div className = "form-group">
                        ...
                        <input type="text" className = "form-control" value = {mobilenumber} onChange = {handleChange} name = "mobilenumber"/>
                    ...
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="projectstatus" id="progress" value="progress" onChange = {handleChange}  checked={projectStatus === "progress" ? true : false}/>
                        <label className="form-check-label" htmlFor="progress" >Progress</label>
                    </div>
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="projectstatus" id="completed" value="completed" onChange = {handleChange}  checked={projectStatus === "completed" ? true : false}/>
                        <label className="form-check-label" htmlFor="completed">Completed</label>
                    </div>
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="projectstatus" id="uncompleted" value="uncompleted" onChange = {handleChange}  checked={projectStatus === "uncompleted" ? true : false}/>
                        <label className="form-check-label" htmlFor="uncompleted">Uncompleted</label>
                    </div>
